...
d. Hospitalizations -> categorical
e. Siri (speech recognition) -> continous
...
d. No, because these are labels representing a category not a number. A `9` represents a class not the number 9. -> true
